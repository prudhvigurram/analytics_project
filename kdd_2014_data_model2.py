...
def print_rslt(count_dic,folder):
    ...
    for project in list(count_dic.keys()):
...
def read_essays(data, project_dic):
    ...
    project_train = []
    count_train = 0
    for project in list(project_dic_train.keys()):
        count_train += 1
    ...
    project_validation = []
    count_validation = 0
    for project in list(project_dic_validation.keys()):
        count_validation += 1
    ...
    project_test = []
    count_test = 0
    for project in list(project_dic_test.keys()):
        count_test += 1
